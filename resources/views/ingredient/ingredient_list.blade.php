            ...
            <div class="mx-auto max-w-6xl">
                ...
                <div class="flex justify-between items-start mb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <span
                            class="text-[10px] font-bold text-gray-400 tracking-widest">{{ $ingredient['category_name'] }}</span>
                    </div>
                ...
                <div class="flex justify-between items-end mb-4">
                    <h3 class="text-base font-bold text-gray-700 tracking-wider truncate pr-2">{{ $ingredient['name'] }}
                    </h3>
                ...
                <div class="flex justify-between items-center pt-3 border-t border-gray-50">
                    <div class="flex items-center gap-2">
                        @if ($ingredient['status_color'] === 'red')
                            <span
                                class="px-2 py-0.5 text-[9px] font-bold text-red-500 bg-red-50 rounded-full tracking-widest">{{ $ingredient['status_text'] }}</span>
                        @elseif ($ingredient['status_color'] === 'amber')
                            <span
                                class="px-2 py-0.5 text-[9px] font-bold text-amber-500 bg-amber-50 rounded-full tracking-widest">{{ $ingredient['status_text'] }}</span>
                        @else
                            <span
                                class="px-2 py-0.5 text-[9px] font-bold text-gray-400 bg-gray-50 rounded-full tracking-widest">{{ $ingredient['status_text'] }}</span>
                        @endif
                    ...
                    <div>
                        ...
                        @elseif ($ingredient['storage_type'] === 1)
                            <span class="text-[9px] font-bold text-cyan-500 bg-cyan-50 px-2 py-1 rounded tracking-widest"><i
